    ...
    $("#register-form").validate({
        ...
        rules: {
            ...
            service_no: {
					   ...
					   remote: "kemailcheck1.php?data=service_no"
					},
			...
			wcc_num:{
					 ...
					 remote: "kemailcheck1.php?data=wcc_num"
				  ...
				  wcc_rec_num:{
					 ...
					 remote: "kemailcheck1.php?data=wcc_rec_num"
        ...
        messages: {
            site_name:"<strong style='color:#FF0000;font-size:14px;'>Enter Site Name</strong>",
			district:"<strong style='color:#FF0000;font-size:14px;'>Enter District</strong>",
            indus_id:"<strong style='color:#FF0000;font-size:14px;'>Enter Indus ID</strong>",
			state:"<strong style='color:#FF0000;font-size:14px;'>Enter State</strong>",
		
			allcoation_date:"<strong style='color:#FF0000;font-size:14px;'>Enter allcoation_date</strong>",
			po_no:"<strong style='color:#FF0000;font-size:14px;'>Enter Po No</strong>",
			po_date:"<strong style='color:#FF0000;font-size:14px;'>Enter Po Date</strong>",
			type_work:"<strong style='color:#FF0000;font-size:14px;'>Enter Type of Work</strong>",
...
xmlhttp.open("GET","get-kdata1.php?q="+str,true);
xmlhttp.send();
}
</script>
<script>
...
<div class="row">
 ...
 <form name="frm" method="post"  action="kbill_suc.php">
...
<?php 
$sql="select distinct req_ref from krefferences ";  // Query to collect records
...
echo "</datalist>";?></datalist>
                                        ...
                                        <td align="right">PO Date</td><td><input type="date" value="<?php echo date('Y-m-d')?>"  name="po_date"  class="form-control"></td>
                                        </tr>
                                        
                                         <tr><td align="right">Site Name</td><td align="left"><input type="text"  class="form-control" name="site_name" id="site_name"></td>
                                        <td align="right">District</td><td><input type="text" name="district" id="district"  class="form-control"></td>
                                        </tr>
                                        <tr><td align="right">Indus ID</td><td align="left"><input type="text"  class="form-control" name="indus_id" id="indus_id"></td>
                                         ...
                                         <tr><td align="right">Seeking Opco ID</td><td align="left"><input type="text"  class="form-control" name="seeking_id" id="seeking_id"></td>
                                        <td align="right">State</td><td><input type="text" name="state" id="state"  class="form-control"></td>
                                        </tr>
                                        <tr><td align="right">Seeking Opco</td><td align="left"><input type="text"  class="form-control" name="seeking_opt" id="seeking_opt"></td>
                                        <td align="right">RFAID date</td><td><input type="date" name="rfaid_date"   class="form-control"></td>
                                        </tr>
                                        <tr><td align="right">Allocation Date</td><td align="left"><input type="text" id="allcoation_date"   class="form-control" name="allcoation_date"></td>
                                        ...
                                        <td align="right">Type of Work</td><td><input type="text" name="type_work" id="type_work"   class="form-control"></td>
                                         ...
                                         <tr>
                                        <td align="right">PCW NO</td><td><input type="text" name="pcw" id="pcw"  class="form-control"></td>
										...
										$rt=mysqli_query($link,"select * from kubill where id='$uid'") or die(mysqli_error($link));
...
<button type="button" class='btn btn-danger delete'>-</button>
                                            ...
                                            <table id="dynamic-table1" class="table table-striped table-bordered table-hover">
                                              ...
                                              <tbody>
											<?php   
												//$yi="select a.line,a.itemdesc,a.uom,a.price,a.qty,a.amount,b.item_code,b.hsn,b.sac,b.cgst,b.sgst,b.igst from  ubill1 a,products b  where a.itemdesc=b.item_desc and b.location='$loc' and b.category='$cat'  and a.id1='$uib' order by a.uid asc";
											//$y1="select a.line,a.itemdesc,a.uom,a.price,a.qty,a.amount,b.item_code,b.hsn,b.sac,b.cgst,b.sgst,b.igst from  ubill1 a left join products b  on a.itemdesc=b.item_desc  where  b.location='$loc' and  b.category='$cat'  and a.id1='$uib' order by a.uid asc";
											$y1="select distinct a.line,a.itemdesc,a.uom,a.price,a.qty,a.amount,b.item_code,b.hsn,b.sac,b.cgst,b.sgst,b.igst from  kubill1 a left join kproducts b  on a.itemdesc=b.item_desc  where  b.location='$loc'  and a.id1='$uib' order by a.uid asc";
