...
echo "</datalist>";?></datalist>
                                        ...
                                        <td align="right">PO Date</td><td><input type="date" value="<?php echo date('Y-m-d')?>"  name="po_date" id="po_date"  class="form-control"></td>
                                        </tr>
                                        <!--<tr><td align="right">Old PO No</td><td align="left"><input  type="text"  class="form-control" name="opo_no" id="opo_no"></td>
                                        <td align="right">Old PO Date</td><td><input type="date" value="<?php echo date('Y-m-d')?>"  name="opo_date" id="opo_date" class="form-control"></td>
                                        </tr>-->
                                        ...
                                        <td align="right">RFAID date</td><td><input type="date" name="rfaid_date"  id="rfaid_date"  class="form-control"></td>
                                        </tr>
										...
										<tr><td align="right">WCC PF</td><td align="left"><input type="date" id="wcc_pf"   class="form-control" name="wcc_pf"></td>
                                        <td align="right">WCC PT</td><td><input type="date" name="wcc_pt" id="wcc_pt"  class="form-control">
