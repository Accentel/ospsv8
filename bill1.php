...
echo "</datalist>";?></datalist>
                                        ...
                                        <tr>
                                        <td align="right">PTW NO</td><td><input type="text" name="pcw" id="pcw"  class="form-control"></td>
...
<button type="button" class='btn btn-danger delete'>-</button>
											...
											$y1="select distinct a.line,a.itemdesc,a.uom,a.price,a.qty,a.amount,b.item_code,b.hsn,b.sac,b.cgst,b.sgst,b.igst from  ubill1 a left join products b  on a.itemdesc=b.item_desc  where  b.location='$loc'  and a.id1='$uib' order by a.uid asc";
