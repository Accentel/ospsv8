					...
					<li class="">
						...
						<ul class="submenu">
                           ...
                           <li class="">
	                        ...
	                        <li class="">
								<a href="approducts_download.php">
									<i class="menu-icon fa fa-caret-right"></i>
									 Download Products
								</a>
				...
				<li class="">
							...
							<li class="">
								<a href="aphsn_wise.php">
									<i class="menu-icon fa fa-caret-right"></i>
									AP HSN/SCNO wise Report 
								</a>
      						</li>
      							<li class="">
								<a href="goahsn_wise.php">
									<i class="menu-icon fa fa-caret-right"></i>
									MH-GOA HSN/SCNO wise Report 
								</a>
      						</li>
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="ttsdprdownload.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Total Ts Dpr Download
								</a>
      						</li>
      					
							<li class="">
								<a href="tmhdprdownload.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Total MH Dpr Download
								</a>
      						</li>
							
							<li class="">
								<a href="tgtdprdownload.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Total GT Dpr Download
								</a>
      						</li>
							<li class="">
								<a href="tapdprdownload.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Total AP Dpr Download
								</a>
      						</li>
