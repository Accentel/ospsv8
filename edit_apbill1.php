...
<div class="row">
 ...
 <form name="frm" method="post" action="apbill_status.php">
 <input type="hidden" name="id" value="<?php echo $id?>">
  ...
  <input type="hidden" name="email" value="<?php echo $email;?>">
                                        ...
                                        <tr><td align="right">PO No</td><td align="left"><input  type="text" value="<?php echo $r['po_no'];?>"  class="form-control" name="po_no" id="po_no" ></td>
                                        <td align="right">PO Date</td><td><input type="date" required name="po_date" value="<?php echo $r['po_date'];?>"  class="form-control"></td>
                                        </tr>
                                        
                                         <tr><td align="right">Site Name</td><td align="left"><input type="text" value="<?php echo $r['site_name'];?>" required class="form-control" name="site_name" id="site_name"></td>
                                        ...
                                        <td align="right">Req.Ref.No</td><td><input type="text" name="req_ref" id="req_ref" value="<?php echo $r['req_ref'];?>" onchange="showHint22(this.value)" required class="form-control"></td>
                                        </tr>
                                        ...
                                        <td align="right">RFAID date</td><td>
                                           <input type="hidden" name="user" value="<?php echo $name;?>" required class="form-control"> 
                                            <input type="date" name="rfaid_date" value="<?php echo $r['rfaid_date'];?>"  class="form-control"></td>
                                        </tr>
                                        <tr><td align="right">Allocation Date</td><td align="left"><input type="date" value="<?php echo $r['allcoation_date'];?>"  class="form-control" id="allcoation_date" name="allcoation_date"></td>
                                        ...
                                        <td align="right">WCC Reciept NO</td><td><input type="text" value="<?php echo $r['wcc_rec_num'];?>" name="wcc_rec_num" id="wcc_rec_num" required class="form-control"></td>
										 ...
										 <option value="apporved" <?php if($r['bill_status']=="apporved"){echo 'selected';} ?> >Approved</option>
										 </select>
										 </td>
                                        </tr>
                                         <tr>
                                        ...
                                        <tr>
                                         <td align="right">Type of Work</td><td><input type="text" name="type_work" id="type_work" required  value="<?php echo $r['type_work'];?>" class="form-control"></td>
                                        
                                        <td align="right">PTW No</td><td><input type="text" name="ptwno" id="ptwno" required  value="<?php echo $r['pcw'];?>" class="form-control"></td>
