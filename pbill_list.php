...
<!--<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['total_amnt'] ?></td>
                                                         <td class="hidden-480"><?php echo $bill_status=$rs1['bill_status']; ?></td>
														...
														<a onclick="window.open('invoice_new.php?id=<?php echo $rs1['id']; ?>&loc=<?php echo $rs1['location'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs" href=""><img src="images/printer.png"></a>
														 <?php }?>
														...
														<a href="" onclick="window.open('sprint.php?id=<?php echo $rs1['id']; ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
														 <?php }?>
														</td>
														<td class="hidden-480">
														<?php if($bill_status!='apporved'){?>
														<img src="images/printer.png">
														 <?php } else {?>	
														<a href="" onclick="window.open('tscheckedlist.php?id=<?php echo $rs1['id']; ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
														 <?php }?>
														</td>
...
echo "<li><a href='pbill_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='pbill_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
