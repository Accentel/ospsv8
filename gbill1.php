    ...
    $("#register-form").validate({
        ...
        rules: {
            ...
            service_no: {
					   ...
					   remote: "emailcheck2.php?data=service_no"
					},
			
			wcc_num:{
				  required: true,
				  remote: "emailcheck2.php?data=wcc_num"
			...
			wcc_rec_num:{
					 ...
					 remote: "emailcheck2.php?data=wcc_rec_num"
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	document.getElementById("indus_id").value=strar[2];	
	document.getElementById("seeking_opt").value=strar[3];
	document.getElementById("po_no").value=strar[4];
	document.getElementById("allcoation_date").value=strar[8];
	//document.getElementById("last").value=strar[11];
    }
  }
xmlhttp.open("GET","get-gdata1.php?q="+str,true);
xmlhttp.send();
}
</script>
<script>
...
<div class="row">
 ...
 <form name="frm" method="post"  action="gbill_suc.php">
...
<?php 
$sql="select distinct req_ref from grefferences ";  // Query to collect records
...
echo "</datalist>";?></datalist>
										...
										$rt=mysqli_query($link,"select * from gubill where id='$uid'") or die(mysqli_error($link));
...
<button type="button" class='btn btn-danger delete'>-</button>
											...
											$y1="select distinct a.line,a.itemdesc,a.uom,a.price,a.qty,a.amount,b.item_code,b.hsn,b.sac,b.cgst,b.sgst,b.igst from  gubill1 a left join gproducts b  on a.itemdesc=b.item_desc  where  b.location='$loc'  and a.id1='$uib' order by a.uid asc";
