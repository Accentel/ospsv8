...
<div class="row">
 ...
 <input type="hidden" name="id" value="<?php echo $id?>">
                                        ...
                                        <tr><td align="right">PO No</td><td align="left"><input  type="text" value="<?php echo $r['po_no'];?>"  class="form-control" name="po_no">
                                        ...
                                        <td align="right">PO Date</td><td><input type="date" required name="po_date" value="<?php echo $r['po_date'];?>"  class="form-control"></td>
                                         ...
                                         <tr><td align="right">Site Name</td><td align="left"><input type="text" id="site_name" value="<?php echo $r['site_name'];?>" required class="form-control" name="site_name"></td>
                                        ...
                                        <tr><td align="right">Indus ID</td><td align="left"><input type="text" value="<?php echo $r['indus_id'];?>" required class="form-control" id="indus_id" name="indus_id"></td>
                                        <td align="right">Req.Ref.No</td><td><input type="text" name="req_ref" value="<?php echo $r['req_ref'];?>" onblur="showHint22(this.value)" required class="form-control"></td>
                                        </tr>
                                        ...
                                        <tr><td align="right">Allocation Date</td><td align="left"><input type="date" value="<?php echo $r['allcoation_date'];?>" required class="form-control" id="allcoation_date" name="allcoation_date"></td>
                                        <td align="right">WCC NO</td><td><input type="text" name="wcc_num" value="<?php echo $r['wcc_num'];?>" required class="form-control"></td>
                                        </tr>
                                         <tr>
                                        <td align="right">WCC Reciept NO</td><td><input type="text" value="<?php echo $r['wcc_rec_num'];?>" name="wcc_rec_num" id="wcc_rec_num" required class="form-control"></td>
                                         ...
                                         <tr>
                                         <td align="right">IRN</td><td><input type="text" value="<?php echo $r['qr_code'];?>" name="bar_code"  class="form-control"></td>
                                        ...
                                        <td align="right">Payment Document Date</td><td><input type="date" value="<?php echo $r['payment_doc_date'];?>" name="payment_doc_date"  class="form-control"></td>
                                        
                                        </tr>
                                         <tr>
                                        <td align="right">PTW NO</td><td><input type="text" name="pcw" id="pcw" value="<?php echo $r['pcw'];?>"  class="form-control"></td>
                                         <td align="right">Ack No</td><td><input type="text" name="ackno" id="ackno" value="<?php echo $r['ackno'];?>"  class="form-control"></td>
                                      
                                        </tr>
                                        <tr>
                                         
                                        <td align="right">Ack Date</td><td><input type="date" value="<?php echo $r['ackdt'];?>" name="ackdt"  class="form-control"></td>
...
<button type="button" class='btn btn-danger delete'>-</button>
 ...
 from add_bill b,products a where b.service_no='$service_no' and b.item_code=a.item_code";*/
												...
												while($rs1=mysqli_fetch_array($sq)){
													...
													?>
                                                    <tr>
													<td><a href="dbfiles/delete_ap.php?id=<?php echo $rs1['id'];  ?>&id1=<?php echo $rs1['id1']; ?>"><img src="images/Icon_Delete.png"/></a></td>
